        ...
        <div className="tw-border tw-border-gray-300 tw-rounded-lg tw-bg-white tw-shadow-sm ">
          ...
          <div className="tw-relative">
            <textarea
              ...
              disabled={disabled}
              className="tw-w-full tw-p-3 tw-pr-12 tw-resize-none tw-outline-none tw-text-sm tw-leading-5 tw-max-h-32 tw-min-h-10 placeholder:tw-text-gray-500 disabled:tw-bg-gray-100 disabled:tw-text-gray-500"
              rows={1}
            />
...
>
  ...
  {pinnedItems && Object.entries(pinnedItems).map(([key, item]) => (
<span
  key={key}
